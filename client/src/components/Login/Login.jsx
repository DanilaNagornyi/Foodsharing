        ...
        <div className="main-agileinfo">
          <div className="agileits-top formdesign">
            <form onSubmit={handleSubmit} >
              <input className="text email inputformdecor" type="email" name="email" placeholder="Email" required="" onChange={handleChange} value={inputs.email} />
              <input className="text email inputformdecor" type="password" name="password" placeholder="Пароль" required="" onChange={handleChange} value={inputs.password} />
            ...
            <p>У вас нет аккаунта? <Link to="/registration"> Регистрация</Link></p>
          </div>
        </div>
